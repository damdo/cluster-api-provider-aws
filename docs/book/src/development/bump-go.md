...
gh api "repos/kubernetes-sigs/cluster-api/contents/cloudbuild.yaml?ref=<TAG>" \
  --jq '.content' | base64 -d

# golangci-lint version
gh api "repos/kubernetes-sigs/cluster-api/contents/.github/workflows/pr-golangci-lint.yaml?ref=<TAG>" \
...
2. **Linter bump** (if version changed):
   ...
   - `hack/tools/Makefile`, `.github/workflows/pr-golangci-lint.yaml`
